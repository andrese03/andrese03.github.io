    ...
    switch (cmd) {
      ...
      case 'theme':
        ...
        if (['matrix', 'dark', 'light'].includes(newTheme)) {
          ...
          return [
            `Invalid theme '${newTheme}'. Valid options: matrix, dark, light`,
          ];
        }
        ...
        {isLoaded ? (
          <div className='mb-4'>
            ...
            <div className='text-sm opacity-75'>
              Type &apos;help&apos; for available commands. Current theme:{' '}
              {theme}
            </div>
            <div className='text-xs opacity-50 mt-2'>
              Connected to portfolio@andrese03.me • Font: Cascadia Code • Use ↑↓
              for history
            </div>
          </div>
        ) : (
