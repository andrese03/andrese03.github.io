...
const mockProjects: Project[] = [
  {
    ...
    title: 'ERP System',
    summary:
      'A lightweight ERP system oriented to local small and medium business.',
  ...
  },
  {
    ...
    title: 'Media Watch',
    summary:
      'Collaborated as Developer Lead to build a social media tool designed to support internal company processes.',
  ...
  },
  {
    ...
    summary:
      'Part of the initial developers to build an application capable of automating many Health Care processes.',
  ...
  },
  {
    ...
    title: 'Plastilap',
    summary:
      "Worked as main developer to build the website promoting Dr. Lapaix's services.",
...
const mockLinks: LinkRef[] = [
  {
    name: 'github',
    url: 'https://github.com/andrese03',
    label: 'GitHub Profile',
  },
  {
    name: 'linkedin',
    url: 'https://linkedin.com/in/andres-encarnacion',
    label: 'LinkedIn Profile',
  },
  {
    name: 'twitter',
    url: 'https://twitter.com/andrese03',
    label: 'Twitter Profile',
  },
  {
    name: 'email',
    url: 'mailto:andresencarnacion03@gmail.com',
    label: 'Email Contact',
  },
];
...
// Main API function
export async function getSheet<T>(
  tab: 'projects' | 'photos' | 'links'
): Promise<T[]> {
  // Check cache first
  ...
  if (!apiBase || apiBase.includes('...')) {
    ...
    console.warn(
      `No valid API endpoint configured for ${tab}, using mock data`
    );
