...
export const metadata: Metadata = {
  ...
  keywords:
    'software developer, web developer, javascript, typescript, react, nextjs, nodejs, full-stack developer, andres encarnacion',
  ...
  openGraph: {
    title: 'Andrés Encarnación | Software Developer',
    description:
      'Full-stack software developer specializing in JavaScript, TypeScript, React, and modern web technologies.',
